  ...
  <a class="navbar-brand mr-3" href="<?php echo base_url();?>index.php/masuk/berandamasuk"><img src="<?php echo base_url();?>assets/img/hexIcons.png" width="100"></a>
   ...
   <div class="input-group">
	...
	<div class="nav-item dropdown mr-5">
	 ...
	 <a class="nav-link dropdown" id="notif" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <button type="button" class="btn" style="button-color: #e0dfdc;">
		<img src="<?php echo base_url();?>assets/img/notif.png" width="25">
		</button>
        </a>
	...
	<div class="nav-item dropdown mr-5">
	 ...
	 <a class="nav-link dropdown" id="akun" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        
		<button type="button" class="btn" style="button-color: #e0dfdc;">
		<img src="<?php echo base_url();?>assets/img/people.png" width="34">
        </button>
		</a>
        <div class="dropdown-menu" aria-labelledby="akun">
		  ...
		  <a class="dropdown-item" href="<?php echo base_url();?>#">Job Linking</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item text-danger" href="<?php echo base_url();?>#"><b>Log Out</b></a>
        </div>
    </div>

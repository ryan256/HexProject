...
<div class="container">
  ...
  <div class="card-body">
	...
	<div class="col-lg-4 text-center">
		...
		<a href="<?php echo base_url();?>index.php/masuk/akun "class="list-group-item list-group-item-action active">Account</a>
		<a href="<?php echo base_url();?>index.php/masuk/dataakun" class="list-group-item list-group-item-action">Edit Profile</a>
		</div>
		</div>
